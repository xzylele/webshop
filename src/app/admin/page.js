...
export default function AdminPage() {
  ...
  const gachaTotalWeight = gachaItems.reduce((sum, item) => sum + item.chance, 0);
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-8 border-b border-white/5 scrollbar-hide">
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'products' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'users' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'coupons' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'gacha' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'transactions' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'banners' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'stats' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
            สรุปรายงานแดชบอร์ด
          </button>
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap border transition-all cursor-pointer ${
              activeTab === 'tickets' ? 'bg-sky-500 text-sky-950 border-sky-500' : 'bg-zinc-950/40 border-white/5 text-zinc-400 hover:text-white'
            }`}
          >
            ...
            {productsLoading ? (
              ...
              <div className="overflow-x-auto border border-white/5 rounded-2xl bg-zinc-950/20 backdrop-blur-md">
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="border-b border-white/5 bg-zinc-950/40 text-zinc-400 font-bold uppercase tracking-wider">
                ...
                <form onSubmit={handleCreateCoupon} className="space-y-3.5">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#03060d] border border-white/5 px-3 py-2 rounded-xl text-xs text-white placeholder-zinc-500 uppercase focus:outline-none focus:border-sky-500"
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full bg-[#03060d] border border-white/5 px-3 py-2 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-sky-500 font-sans"
                    >
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {couponsLoading ? (
                ...
                <div className="overflow-x-auto border border-white/5 rounded-2xl bg-zinc-950/20 backdrop-blur-md">
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="border-b border-white/5 bg-zinc-950/40 text-zinc-400 font-bold uppercase tracking-wider font-sans">
                        ...
                        <tr key={c._id} className="hover:bg-white/5 transition-colors">
                          ...
                          <td className="p-4 text-right space-x-2">
                            <button
                              ...
                              className={`inline-flex items-center gap-1 border p-1.5 rounded-lg cursor-pointer transition-colors ${
                                c.isActive 
            ...
            <div className="space-y-4">
              <div className="glass p-5 rounded-2xl border border-white/5 space-y-4">
                ...
                <form onSubmit={handleCreateGachaItem} className="space-y-3.5">
                  ...
                  <div className="space-y-1">
                    <label className="text-[11px] text-zinc-400 font-semibold block">ค่าน้ำหนักโอกาสได้รางวัล (Weight Chance) *</label>
                    <input
                      type="number"
                      required
                      min="1"
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5 text-zinc-300">
                      {gachaItems.map((item) => {
                        ...
                        const percentChance = gachaTotalWeight > 0 
                          ? ((item.chance / gachaTotalWeight) * 100).toFixed(2) 
                          : '0.00';
                          ...
                          <tr key={item._id} className="hover:bg-white/5 transition-colors">
                            ...
                            <td className="p-4">
                              <span className={`inline-flex items-center text-[10px] font-semibold px-2 py-0.5 rounded border ${
                                ...
                                {item.type === 'code' ? 'คีย์โค้ด/ไอดี' : item.type === 'coupon' ? 'คูปองลดเงิน' : 'เกลือ'}
                              </span>
                            </td>
                            <td className="p-4 font-bold text-amber-400">
                              <span>น้ำหนัก: {item.chance} </span>
          ...
          <div className="space-y-6 animate-in fade-in-50 duration-200">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="glass p-5 rounded-2xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                  <span className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">ผู้ใช้ทั้งหมด</span>
                  <h3 className="text-xl sm:text-2xl font-black text-white mt-0.5">
                    {statsLoading ? <span className="inline-block w-16 h-6 skeleton-pulse rounded" /> : stats?.users?.toLocaleString()}
                  </h3>
                </div>
              </div>
              ...
              <div className="glass p-5 rounded-2xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                  <span className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">ประเภทสินค้า</span>
                  <h3 className="text-xl sm:text-2xl font-black text-white mt-0.5">
                    {statsLoading ? <span className="inline-block w-16 h-6 skeleton-pulse rounded" /> : stats?.products?.toLocaleString()}
                  </h3>
                </div>
              </div>
              ...
              <div className="glass p-5 rounded-2xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                  <span className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">สต๊อกคลังรวม</span>
                  <h3 className="text-xl sm:text-2xl font-black text-white mt-0.5">
                    {statsLoading ? <span className="inline-block w-16 h-6 skeleton-pulse rounded" /> : stats?.stock?.toLocaleString()}
                  </h3>
                </div>
              </div>
              ...
              <div className="glass p-5 rounded-2xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                  <span className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">จำหน่ายรวม</span>
                  <h3 className="text-xl sm:text-2xl font-black text-white mt-0.5">
                    {statsLoading ? <span className="inline-block w-16 h-6 skeleton-pulse rounded" /> : stats?.sold?.toLocaleString()}
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="glass p-6 rounded-2xl border border-white/5 space-y-4">
              <h3 className="text-base font-bold text-white font-bold">ข้อมูลการบริหารจัดการ</h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                ระบบร้านค้า NakataShop ทำงานแบบเซิร์ฟเวอร์เลส (Serverless APIs) บน Next.js 
                โดยเชื่อมต่อฐานข้อมูล Supabase PostgreSQL ทำให้ทุก ๆ คำสั่งซื้อ หรือการทำรายการเติมเงินของลูกค้าจะได้รับการอัปเดตและหักลดสต็อกสินค้าทันที 
                ช่วยให้ลดความผิดพลาดในการขายสินค้าเกินสต็อก (Over-selling) ได้อย่างเด็ดขาด
              </p>
              
              <div className="p-4 bg-zinc-950/40 border border-white/5 rounded-xl text-xs space-y-2">
                <span className="font-semibold text-zinc-300 block">การรับประกันการเข้าถึงฐานข้อมูล:</span>
                <span className="text-emerald-400 flex items-center gap-1.5">
                  <span className="w-2 h-2 bg-emerald-500 rounded-full animate-ping" />
                  Supabase Connection Status: ACTIVE
                </span>
                <span className="text-zinc-500 block">URL: https://sgoicwwwdhkojispwddm.supabase.co</span>
              </div>
            </div>
          </div>
        )}
                ...
                <form onSubmit={selectedBannerToEdit ? handleEditBannerSubmit : handleCreateBanner} className="space-y-4 font-sans">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#03060d] border border-white/5 px-3 py-2.5 rounded-xl text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-sky-500"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full bg-[#03060d] border border-white/5 px-3 py-2.5 rounded-xl text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-sky-500 resize-none"
                    />
                  </div>
                    ...
                    <div className="flex bg-zinc-900 border border-white/5 p-1 rounded-xl w-full">
                      <button
                        ...
                        className={`flex-1 text-[11px] font-bold py-1.5 rounded-lg transition-all cursor-pointer ${
                          bannerImgMode === 'url' ? 'bg-sky-500 text-sky-950 shadow' : 'text-zinc-400 hover:text-white'
                        }`}
                      >
                        กรอก URL รูป
                      </button>
                      <button
                        ...
                        className={`flex-1 text-[11px] font-bold py-1.5 rounded-lg transition-all cursor-pointer ${
                          bannerImgMode === 'upload' ? 'bg-sky-500 text-sky-950 shadow' : 'text-zinc-400 hover:text-white'
                        }`}
                      >
                        อัพโหลดไฟล์
                      </button>
                  ...
                  {bannerImgMode === 'url' ? (
                    <div className="space-y-1">
                      <input
                        ...
                        className="w-full bg-[#03060d] border border-white/5 px-3 py-2.5 rounded-xl text-xs text-white placeholder-zinc-600 focus:outline-none focus:border-sky-500 font-mono"
                      />
                    </div>
                  ) : (
                  ...
                  adminTickets.map((ticket) => (
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-2xl border transition-all cursor-pointer block space-y-2.5 ${
                        selectedAdminTicketId === ticket._id 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm">
          ...
          <div className="relative w-full max-w-md bg-[#060c13] border border-white/5 p-6 rounded-2xl shadow-2xl glass z-10 animate-in fade-in duration-200">
            ...
            <form onSubmit={handleEditGachaItemSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-xs text-zinc-400 font-semibold block">ค่าน้ำหนักโอกาสได้รางวัล (Weight Chance) *</label>
                <input
                  type="number"
                  required
                  min="1"
